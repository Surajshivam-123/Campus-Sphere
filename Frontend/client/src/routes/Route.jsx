    ...
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        <Route element={<PageLayout />}>
          ...
          />
          <Route
            path="/event-details/:identityNumber/:participantCode/:participantId"
            element={
              <ProtectedRoute>
                <EventDetailsPage />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/get-event/:memberCode"
            element={
              <ProtectedRoute>
                <EventDetailsMemberPage />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          {/* Schedule */}
          <Route
            path="/sports/cricket/schedule/:eventId"
            element={
              <ProtectedRoute>
                <SchedulePage />
              </ProtectedRoute>
          ...
          {/* ── Cricket Routes ──────────────────────────────────────────────────── */}
          <Route
            path="/organizer/cricket/:eventId"
            element={
              <ProtectedRoute>
                <CricketOrganizerPage />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          />
          <Route
            path="/sports/cricket/format/:eventId"
            element={
              <ProtectedRoute>
                <CricketFormat />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/format/:eventId/view"
            element={
              <ProtectedRoute>
                <CricketFormat viewOnly />
              </ProtectedRoute>
            }
          />
          <Route
            path="/sports/cricket/event-details/:eventId/:identityNumber/:participantCode/:participantId"
            element={
              <ProtectedRoute>
                <CricketEventDetails />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/join-team/:eventId"
            element={
              <ProtectedRoute>
                <CricketJoinTeam />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/create-team/:eventId"
            element={
              <ProtectedRoute>
                <CricketCreateTeam />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/team-creator/:eventId"
            element={
              <ProtectedRoute>
                <CricketTeamCreator />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/team-member/:eventId"
            element={
              <ProtectedRoute>
                <CricketTeamMember />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/scoreboard/:eventId"
            element={
              <ProtectedRoute>
                <CricketLiveScoreboard />
              </ProtectedRoute>
            }
          />
          <Route
            path="/sports/cricket/match/:matchId/scorecard"
            element={
              <ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/match/:matchId/score-input"
            element={
              <ProtectedRoute>
                <CricketScoreInput />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/match-manager/:eventId"
            element={
              <ProtectedRoute>
                <CricketMatchManager />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/sports/cricket/match/:matchId/squad-submit"
            element={
              <ProtectedRoute>
                <CricketSquadSubmit />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/coding/problem/new/:eventId"
            element={
              <ProtectedRoute>
                <ProblemEditor />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/coding/problem/edit/:problemId"
            element={
              <ProtectedRoute>
                <ProblemEditor />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/coding/leaderboard/:eventId"
            element={
              <ProtectedRoute>
                <Leaderboard />
              </ProtectedRoute>
